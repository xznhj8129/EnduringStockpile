...
ENT.PrintName                        =  "REN-250 warhead (250 kilotons)"
ENT.Author                           =  "snowfrog"
ENT.Contact                          =  ""
...
-- Scale factor: 1:12
ENT.TotalRadius                      =  3200 -- 200psi range or fireball size (whichever bigger), everything vaporized (1400 minimum for the removal to work)
ENT.DestroyRadius                    =  12600 -- 5psi range, all constraints break
ENT.BlastRadius                      =  27000 -- 1.5psi range, unfreeze props
ENT.ExplosionRadius                  =  35000 -- Max range at which things move
ENT.FalloutRadius                    =  9200 -- 500rem range, fallout range
ENT.VaporizeRadius                   =  8800 -- 5th degree burn range (100 cal/cm^2), player/npc is just gone
ENT.CremateRadius                    =  14500 -- 4th degree burn range (35 cal/cm2), player becomes skeleton
ENT.IgniteRadius                     =  25600 -- 3rd degree burn range (8 cal/cm^2), player becomes crispy, things ignite
ENT.Burn2Radius                      =  33600 -- 2nd degree burn range (5 cal/cm^2), player becomes burn victim
ENT.Burn1Radius                      =  46000 -- 1st degree burn range (3 cal/cm^2), player catches fire for 1sec
