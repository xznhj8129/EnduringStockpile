...
function ENT:Explode()
    ...
    if(self:WaterLevel() >= 1) then  -- explosion height type determination
     ...
     elseif self.Yield == 500 then
        ...
        self.Rad5000rem                       =  7700 -- 5000rem initial radiation range, death within a minute
        self.Rad1000rem                       =  9400 -- 1000rem initial radiation range, death within 5 minutes
        self.Rad500rem                        =  10100 -- 500rem range, 50-50 death within 5 minutes
        if self.BurstType == 1 then -- airburst
        ...
        self.EffectWater                      =  "hbomb_underwater"
        self.ExplosionSound                   =  "gbombs_5/explosions/nuclear/nukeaudio3.mp3"
        self.Rad5000rem                       =  8500 -- 5000rem initial radiation range, death within a minute
        self.Rad1000rem                       =  10200 -- 1000rem initial radiation range, death within 5 minutes
        self.Rad500rem                        =  11000 -- 500rem range, 50-50 death within 5 minutes
        if self.BurstType == 1 then -- airburst
            self.TotalRadius                      =  4200 -- delete (fireball or 200psi, whichever bigger) range, everything vaporized (1400 minimum for the removal to work)
